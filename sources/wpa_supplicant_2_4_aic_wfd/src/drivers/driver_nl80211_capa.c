				       ...
				       struct wiphy_info_data *info)
{
	...
	/*
	 * RTL8723BU advertises concurrent P2P through nl80211, but the vendor
	 * driver does not handle separate P2P group interfaces reliably. Keep
	 * P2P capable, but force the legacy single-interface P2P path.
	 */
