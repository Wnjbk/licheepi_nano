...
// arg0: src_h << 16 | src_w, frontend input size.
// arg1: out_h << 16 | out_w, frontend output/backend layer size.
// arg2: y << 16 | x, signed 16-bit backend layer coordinate.
#define DRM_SRGN_ATOMIC_COMMIT_MOUNT_SET_YUV_VIEW 0x04
// arg0: full_h << 16 | full_w, real decoded frame/pitch size.
