...
#define SUN4I_FRONTEND_EN_BIST				BIT(31)

#define SUN4I_FRONTEND_STATUS_REG       0x068
#define SUN4I_FRONTEND_STATUS_COEF_ACCESS_STATUS       BIT(11)
...
#define SUN4I_FRONTEND_INPUT_FMT_BYTE_SEQ_P3210		(0 << 16)
#define SUN4I_FRONTEND_INPUT_FMT_BYTE_SEQ_P0123		(1 << 16)
...
#define SUN4I_FRONTEND_OUTPUT_FMT_BYTE_SEQ_P3210	(0 << 5)
#define SUN4I_FRONTEND_OUTPUT_FMT_BYTE_SEQ_P0123	(1 << 5)
